...
All 16 pe-* skills are installed and available as Perplexity Computer custom skills. Users invoke them by name directly in conversation. No additional setup is required — skills are read from the `_skills/` directory in this repository.
