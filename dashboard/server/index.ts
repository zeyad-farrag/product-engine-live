...
app.use((req, res, next) => {
  ...
  if (process.env.NODE_ENV !== "production" || !origin) {
    ...
    // No CORS_ORIGINS set — allow same-origin only (no header = browser blocks cross-origin)
...
(async () => {
  ...
  const tokenResult = await validateGitHubToken();
  log(tokenResult.message, "github");
